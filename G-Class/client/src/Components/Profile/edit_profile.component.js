...
const EditProfile = () => {
  ...
  useEffect(() => {
    if (inputNewPassword !== inputPasswordConfirmation)
  ...
  const updatePassword = e => {
    e.preventDefault();
    const token = new Cookies().get('token');
    Axios.post(`${URL}/users/password/update`, {
      token,
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="container">
        <form
          className="margin-top-bottom box text-dark edit"
        ...
        >
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={({ target: { value } }) => setInputNewPassword(value)}
            />
          </div>
          <div className="form-group">
