      ...
      <div className="container margin-top-bottom">
        <div className="col-9">
          ...
          {classwork.author === userInfo._id ? (
            <div>
              <h3>
                <span className="link" onClick={openClasswork}>
                  Edit
                </span>
              </h3>
              <h3>
                <span className="link text-danger" onClick={deleteClasswork}>
                  Delete
                </span>
              </h3>
            </div>
        ...
        !(
          ...
          <div className="col-3">
            {!answered ? (
              <form className="box " onSubmit={Answer}>
                    ...
                    return (
                      <li key={option}>
                        ...
                        <span
                          ...
                          onClick={() =>
                            setInputChoices(
                              inputChoices.filter(options => options !== option)
                            )
                          }
                        >
                          Delete
