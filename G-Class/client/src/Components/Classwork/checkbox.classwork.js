...
const Checkbox = (params) => {
  ...
  useEffect(() => {
    Axios.get(`${URL}/classwork/get/${classworkId}`).then((res) => {
      if (res.data.types === "checkbox") {
    ...
    <div className="container-fluid">
      ...
      <div className="container margin-top-bottom margin-left-bottom ">
        <div className="col-9">
          ...
          {classwork.author === userInfo._id ? (
            <div className='flwx'>
              ...
              <h3>
                <span className="link text-danger class-link" onClick={deleteClasswork}>
                  Delete
                </span>
              </h3>
            </div>
        ...
        !(
          ...
          <div className="col-3 ">
            {!answered ? (
              <form className="box padding-class" onSubmit={Answer}>
                <h1 className="box-title">Answer</h1>
                <div>
                  {classwork.options &&
                    classwork.options.map((option) => (
                      <div className="form-group" key={option}>
                        <input
                          ...
                          onChange={({ target: { checked, value } }) => {
                            if (checked)
                              setInputAnswer((prev) => [...prev, value]);
                            else
                              setInputAnswer(
                                inputAnswer.filter((answer) => answer !== value)
                              );
                          }}
                        />
        ...
        <div className="classwork-modal" id="answers">
          <div className="classwork-content container">
            ...
            {answers.map((answer) => {
              return (
                <p key={answer._id}>
                  {answer.student.username} answered{" "}
                  <b>{answer.answer.join(", ")}</b>{" "}
