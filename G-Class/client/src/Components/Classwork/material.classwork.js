  ...
  return (
    <div className="container-fluid">
      ...
      <div className="container ">
        <div className="margin-top-bottom margin-left-bottom">
          ...
          {/* <p>
            posted {moment(material.createdAt).fromNow()}
            {material.createdAt !== material.updatedAt ? (
              <span>(updated {moment(material.updatedAt).fromNow()})</span>
            ) : null}{' '}
            by {author}
          </p> */}
          {material.author === userInfo._id ? (
            <div className="flwx">
              <h3>
                <span className="link class-link" onClick={openMaterial}>
                  Update
                </span>
              </h3>
              <h3>
      ...
      <div className="classwork-modal" id="classwork">
        <div className="classwork-content container">
          ...
          <form onSubmit={updateClasswork}>
            ...
            <div className="form-group">
              <input type="submit" className="form-control btn button-style" />
            </div>
          </form>
        </div>
      </div>
