    ...
    <div className="container-fluid">
      ...
      <div className="container">
        ...
        (ClassInfo.owner === userInfo._id ||
          ...
          <button
            className="margin-top-bottom btn add-classwork-btn"
          ...
          ? classworks.map(classwork => {
              if (
                ...
                return (
                  ...
                  >
                    <h3 className="classwork-title box box-title">
                    ...
                    <p className='padding-class'>{classwork.description}</p>
                  </div>
      ...
      <div className="classwork-modal" id="classwork">
        <div className="classwork-content container" >
          ...
          <h1 className="box-title boxxx">Create a classwork</h1>
          <form onSubmit={createClasswork}>
            ...
            <div className="form-group">
              <p className="form-label">
                Description{' '}
                {inputType !== 'material' ? <span>(optional)</span> : null}:
              </p>
              {inputType === 'material' ? (
                <textarea
                  rows="5"
