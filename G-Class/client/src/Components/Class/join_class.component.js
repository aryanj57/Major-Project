...
const JoinClass = () => {
  ...
  useEffect(() => {
    if (inputTitle.length > 100)
      setCreateError('Title length must less or equal to 100');
    else {
      if (inputDescription.length > 500)
        setCreateError('Description length must less or equal to 500');
      else setCreateError('');
    }
  }, [inputTitle, inputConference, inputDescription]);
    ...
    <div className="container-fluid">
      ...
      <div className="container">
        <div className="margin-top-bottom box box-shadow">
          <button
            className="btn add-classwork-btn-light join "
            onClick={openJoinTab}
          >
            Join class
          </button>
          <button
            className="btn add-classwork-btn  join"
          ...
          <div className="box-text">
            ...
            >
              ...
              <div className="form-group">
                <p className="form-label">Meet</p>
                <input
                  type="text"
                  className="form-control"
                  value={inputConference}
                  onChange={({ target: { value } }) =>
                    setInputConference(value)
                  }
                />
              </div>
              <div className="form-group">
